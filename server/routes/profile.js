...
router.put('/', async (req, res) => {
    try {
        const { age, gender, address, region, pincode, height_cm, weight_kg } = req.body;
        ...
        if (height_cm !== undefined) req.user.profile.height_cm = height_cm;
        if (weight_kg !== undefined) req.user.profile.weight_kg = weight_kg;
