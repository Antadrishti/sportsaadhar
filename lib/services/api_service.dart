...
class ApiService {
  ...
  static String get baseUrl {
    // Return env var if available, otherwise fallback to physical device default
    return dotenv.env['API_BASE_URL'] ?? 'http://192.168.10.100:3000/api';
  }
  ...
  static Future<Map<String, dynamic>> updateProfile({
    ...
    try {
      ...
      if (height != null) body['height_cm'] = height; // Map to backend field
      if (weight != null) body['weight_kg'] = weight; // Map to backend field
