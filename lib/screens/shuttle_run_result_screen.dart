...
import 'dart:ui'; // For FontFeature if needed, though mostly for tracking screen
import '../models/physical_test.dart';
import '../models/test_result_model.dart';
import '../services/shuttle_run_service.dart';
      ...
      if (mounted) {
        ...
        if (mounted) {
          Navigator.pushNamedAndRemoveUntil(
            context,
            '/home', 
             // Note: Route to remove until. In Height app it is typically home.
             // Original code had '/physical-assessment', but here assuming Home is the main hub.
            (route) => false,
          );
        }
      }
