  ...
  Future<void> _saveResult() async {
    ...
    try {
      ...
      await _testResultsService.saveTestResult(
        ...
        testName: 'Broad Jump',
        testType: 'leg_power',
        distance: _jumpDistanceCm, // Saving in CM
        timeTaken: 0,
        speed: 0,
      );
                          ...
                          children: [
                            if (_validLanding)
                              ElevatedButton(
                                ...
                                child: _isSaving ? const SizedBox(width:20, height:20, child: CircularProgressIndicator(color:Colors.white)) : const Text("Save", style: TextStyle(color: Colors.white)),
                              ),
