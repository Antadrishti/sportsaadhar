...
/// Face verification screen for sit-ups test
class SitupsFaceVerificationScreen extends StatefulWidget {
  final PhysicalTest test;
  final String? videoPath; // Video path from recording screen

  const SitupsFaceVerificationScreen({
    super.key,
    required this.test,
    this.videoPath,
  });
  ...
  @override
  State<SitupsFaceVerificationScreen> createState() =>
      _SitupsFaceVerificationScreenState();
}

class _SitupsFaceVerificationScreenState
    extends State<SitupsFaceVerificationScreen> {
  ...
  Future<void> _analyzeTest() async {
    try {
      ...
      final result = await _situpsService.countSitupsFromVideo(widget.videoPath!);
